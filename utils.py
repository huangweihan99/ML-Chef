...
def recipe_to_txt(recipe):
    ...
    full_recipe += f"- {ingredient}\n"
    full_recipe += "___________________________________________________________________________________________________________________________________________\n"
